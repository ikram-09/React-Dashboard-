...
const Cart = () => {
  const { currentColor, setCartCencel, cartCencel, handleClose } = useStateContext();
  console.log('setCartCencel: ', setCartCencel);
  console.log('currentColor: ', currentColor);

  return (
    <div   className="bg-half-transparent w-full fixed nav-item top-0 right-0" onClick={() => handleClose("cart")}>
